...
- Preloaded helpers (`scope_at`, `scope_at_test`, `resolve_position`, `run_syntax_tests`, `probe_scopes`, `open_view`, `assign_syntax_and_wait`, `find_resources`, `wait_for_resource`, `wait_for_scope`, `temp_user_packages_dir`, `reload_syntax`) are in scope without import.
